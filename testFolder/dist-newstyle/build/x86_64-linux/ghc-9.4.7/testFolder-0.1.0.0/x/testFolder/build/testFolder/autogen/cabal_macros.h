...
/* package testFolder-0.1.0.0 */
#ifndef VERSION_testFolder
#define VERSION_testFolder "0.1.0.0"
#endif /* VERSION_testFolder */
#ifndef MIN_VERSION_testFolder
#define MIN_VERSION_testFolder(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_testFolder */
...
#define CURRENT_COMPONENT_ID "testFolder-0.1.0.0-inplace-testFolder"
